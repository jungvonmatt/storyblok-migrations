...
export async function generateTypes() {
  try {
    ...
    if (!fs.existsSync(schemaFile)) {
      console.error(
        pc.red(
          `✗ Components schema file not found at ${schemaFile}. Please run 'storyblok-migrate pull-components' first.`
        )
      );
      process.exit(1);
    }
    ...
    try {
      await storyblokToTypescript({
        ...
        compilerOptions: {
          ...
          bannerComment: `
            /**
             * This type/interface was automatically generated by storyblok-migrate generate-types.
             * DO NOT MODIFY IT BY HAND. Instead, run storyblok-migrate pull-components,
             * and then storyblok-migrate generate-types to regenerate this file.
            */`.trim(),
